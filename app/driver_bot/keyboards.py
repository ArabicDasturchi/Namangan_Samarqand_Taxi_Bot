...
def select_direction_keyboard():
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="➡️ Namangandan -> Samarqandga", callback_data="dir_to_samarqand")],
        [InlineKeyboardButton(text="⬅️ Samarqanddan -> Namanganga", callback_data="dir_from_samarqand")]
    ])
